...
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch5\Serializers\SmartSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch5\Serializers\ArrayToJSONSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch5\Serializers\EverythingToJSONSerializer');
            ->build();
----
